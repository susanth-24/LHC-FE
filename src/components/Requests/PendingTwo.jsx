                    ...
                    <div class="relative overflow-x-auto">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500  ">
                            ...
                            <tbody>
                                {ShowAll ? (
                                    filteredRequests
                                        ?.filter((row) => row?.requestStatus_1 === 'Approved' && row?.requestStatus_2 === 'Approved' && row?.requestStatus_3 === 'Approved')
                                        ?.map((row, index) => (
                                            <tr key={index} className="bg-white border-b">
                                                ...
                                                <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                                    <Link to={`/request/executive/${row._id}`} className="hover:underline">
                                                        Edit
                                                    </Link>
                                                </td>
                                            </tr>
