                    ...
                    <>
                        <div class="relative overflow-x-auto">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500  ">
                                ...
                                <tbody>
                                    {ShowAll ? (
                                        categoryObj?.data?.filter((row) => row?.requestStatus_2 === 'Pending' && row?.requestStatus_3 === 'Approved')?.map((row, index) => (
                                        ...
                                        categoryObj?.data?.slice(0, 10)?.filter((row) => row?.requestStatus_2 === 'Pending' && row?.requestStatus_3 === 'Approved')?.map((row, index) => (
                                            <tr key={index} className="bg-white border-b">
                                                <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                                    {row.name}
                                                </th>
                    ...
                    <>
                        <div class="relative overflow-x-auto">
                            <table class="w-full text-sm text-left rtl:text-right text-gray-500  ">
                                ...
                                <tbody>
                                    {ShowAll ? (
                                        categoryObj?.data?.filter((row) => row?.requestStatus_3 === 'Pending')?.map((row, index) => (
                                            <tr key={index} className="bg-white border-b">
                                                <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                                    {row.name}
                                                </th>
                                        ...
                                        categoryObj?.data?.filter((row) => row?.requestStatus_3 === 'Pending')?.slice(0, 10)?.map((row, index) => (
                                            <tr key={index} className="bg-white border-b">
                                                <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                                                    {row.name}
                                                </th>
