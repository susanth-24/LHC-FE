        ...
        <div className="mx-auto max-w-2xl py-20 sm:py-48 lg:py-6">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Welcome to the Lecture Hall Booking Portal, your one-stop destination
              for reserving lecture halls within our state-of-the-art lecture hall
              complex for your club sessions and events.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              {(!user?.result) ? (
                ...
                <Link to={route}>
                <button type="button" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Book Hall</button>
                </Link>
              )}
